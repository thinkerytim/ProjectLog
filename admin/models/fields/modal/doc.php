 ...
 * @since       3.3.1
 */
class JFormFieldModal_Doc extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		$html	= array();
		$link	= 'index.php?option=com_projectlog&amp;view=docs&amp;layout=modal&amp;tmpl=component&amp;function=jSelectDoc_' . $this->id;
		...
		if ($allowClear)
		{
			$html[] = '<button id="' . $this->id . '_clear" class="btn' . ($value ? '' : ' hidden') . '" onclick="return jClearDoc(\'' . $this->id . '\')"><span class="icon-remove"></span> ' . JText::_('JCLEAR') . '</button>';
		}
