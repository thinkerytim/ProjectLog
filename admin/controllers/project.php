...
class ProjectlogControllerProject extends JControllerForm
{
	 ...
	 * @since  3.3.1
	 */
	protected $text_prefix = 'COM_PROJECTLOG_PROJECT';
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_projectlog&view=projects' . $this->getRedirectToListAppend(), false));
