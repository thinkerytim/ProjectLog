    ...
    <table class="adminlist" cellspacing="1">
        <thead>
            <tr>
                ...
                <th width="10%"><?php echo JHTML::_('grid.sort', JText::_('NAME'), 'name', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                <th width="10%"><?php echo JHTML::_('grid.sort', JText::_('FILENAME'), 'path', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                <th width="10%"><?php echo JHTML::_('grid.sort', JText::_('PROJECT'), 'project_id', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>                
                <th width="10%"><?php echo JHTML::_('grid.sort', JText::_('SUBMITTED DATE'), 'date', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                <th width="10%"><?php echo JHTML::_('grid.sort', JText::_('SUBMITTED BY'), 'submittedby', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>                
            </tr>
        </thead>
        <tfoot>
            <tr>
        ...
        <tbody>
            ...
            if(count($this->rows)){
                ...
                <tr class="<?php echo "row$k"; ?>">
                    ...
                    <td align="left"><a href="<?php echo $filelink;?>" target="_blank"><?php echo $row->path; ?></a></td>
                    ...
                    <td align="center"><?php echo ($row->submittedby) ? projectlogHTML::getUserName($row->submittedby) : '--'; ?>&nbsp;</td>
                </tr>
                <?php $k = 1 - $k; } ?>
            <?php }else{ ?>
                <tr>
                    <td colspan="7" align="center"><?php echo JText::_('NO DOCS'); ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
