 ...
 * @subpackage  com_projectlog
 */
class ProjectlogControllerLogform extends JControllerForm
{
	protected $view_item = 'logform';
	 ...
	 * @since   3.3.1
	 */
	public function getModel($name = 'logform', $prefix = '', $config = array('ignore_request' => true))
	{
