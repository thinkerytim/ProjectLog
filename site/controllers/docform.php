 ...
 * @subpackage  com_projectlog
 */
class ProjectlogControllerDocform extends JControllerForm
{
	protected $view_item = 'docform';
	...
	protected function allowAdd($data = array())
	{
		...
		$projectId = JArrayHelper::getValue($data, 'project_id', $this->input->getInt('project_id'), 'int');
		$allow = null;
	 ...
	 * @since   3.3.1
	 */
	public function getModel($name = 'docform', $prefix = '', $config = array('ignore_request' => true))
	{
