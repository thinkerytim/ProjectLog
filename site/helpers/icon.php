...
class JHtmlIcon
{
	public static function email($project, $params, $attribs = array())
	{
	...
	{
		$url  = ContentHelperRoute::getProjectRoute($project->slug, $project->catid);
	...
	public static function print_screen($project, $params, $attribs = array())
	{
		// checks template image directory for image, if non found default are loaded
		if ($params->get('show_icons'))
		{
